...
module.exports.run = async(client, message, args) => {
    ...
    let role         = message.guild.roles.get("710544634652393523");
    let invite_role  = message.guild.roles.get("710545220596662293");
    let member       = message.member;
    let generalChannel = "710528336342024214";


    if(message.member.roles.has("710544634652393523")){

        message.channel.send("Mais t'as déjà le rôle 'Membre Guilde', keske tu viens me le demander >.<")
